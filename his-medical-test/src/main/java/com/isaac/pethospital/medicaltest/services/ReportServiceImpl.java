...
public class ReportServiceImpl implements ReportService {
    ...
    private ReportEntity getReportByUuid(ReportOperationRequest request) {
        if (StringUtils.isEmpty(request.getUuid()) )
            throw new RuntimeException("Report Uuid is null");

        ReportEntity reportEntity = this.reportRepository.findByUuid(request.getUuid());
        if (reportEntity == null)
            throw new RuntimeException("Cannot find Report");
    ...
    public boolean updateReport(ReportOperationRequest request) {
        ...
        ReportEntity reportEntity = getReportByUuid(request);
