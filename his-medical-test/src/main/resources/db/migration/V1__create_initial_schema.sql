...
create table report_template_entity (id bigint not null auto_increment, report_name varchar(255), report_name_han_yu_pin_yin varchar(255), primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
