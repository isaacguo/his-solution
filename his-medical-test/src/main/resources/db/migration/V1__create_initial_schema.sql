...
create table department_entity_supported_report_templates (department_entity_id bigint not null, supported_report_templates_id bigint not null) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table report_entity (id bigint not null auto_increment, created_date_time datetime, finished_date_time datetime, paid_date_time datetime, report_name varchar(255), report_status integer, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
create table report_template_entity (id bigint not null auto_increment, report_name varchar(255), primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table report_template_entity_department_list (report_template_entity_id bigint not null, department_list_id bigint not null) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
alter table department_entity_supported_report_templates add constraint FK1dnjd1dkqi4bkwuut154tn9o1 foreign key (supported_report_templates_id) references report_template_entity (id);
alter table department_entity_supported_report_templates add constraint FK3o3s9ug8lvffitp12fr5qmrs9 foreign key (department_entity_id) references department_entity (id);
...
alter table report_template_entity_department_list add constraint FKbuvjn40u98hont0gcgtx0vcip foreign key (report_template_entity_id) references report_template_entity (id);
