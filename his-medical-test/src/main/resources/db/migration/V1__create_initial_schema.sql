...
create table report_entity (id bigint not null auto_increment, report_name varchar(255), primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table report_item_entity (id bigint not null auto_increment, comments varchar(255), item_name varchar(255), item_unit varchar(255), reference_high_limit_value varchar(255), reference_low_limit_value varchar(255), report_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
