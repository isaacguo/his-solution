...
create table charge_entity (id bigint not null auto_increment, charge_uuid varchar(255), charged_date datetime, created_date datetime, doctor_uuid varchar(255), name varchar(255), pet_owner_uuid varchar(255), pet_uuid varchar(255), request_uuid_from_service varchar(255), status integer, total_amount decimal(19,2), treatment_case_uuid varchar(255), uuid varchar(255), primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
