create table company_entity (id bigint not null auto_increment, company_location varchar(255), company_name varchar(255), uuid binary(255), primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table contact_address_entity (id bigint not null auto_increment, address varchar(255), city varchar(255), country varchar(255), district varchar(255), home_phone varchar(255), mobile_phone varchar(255), personal_email varchar(255), post varchar(255), work_phone varchar(255), employee_entity_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table department_entity (id bigint not null auto_increment, name varchar(255), company_id bigint, parent_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table employee_entity (id bigint not null auto_increment, date_of_birth tinyblob, driver_license_number varchar(255), email varchar(255), emergency_contact varchar(255), emergency_phone_number varchar(255), employee_number varchar(255), employment_status integer, ethnic varchar(255), full_name varchar(255), gender varchar(255), given_name varchar(255), id_number varchar(255), job_title varchar(255), joined_date tinyblob, login_account varchar(255), marital_status varchar(255), nationality varchar(255), surname varchar(255), uuid varchar(255), work_phone_number varchar(255), contact_address_id bigint, department_id bigint, department_in_charge_id bigint, direct_report_to_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table leave_info_entity (id bigint not null auto_increment, anuual_leave bigint not null, sick_leave bigint not null, employee_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table leave_record_entity (id bigint not null auto_increment, employee_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table salary_entity (id bigint not null auto_increment, base_salary bigint not null, bonus bigint not null, employee_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
