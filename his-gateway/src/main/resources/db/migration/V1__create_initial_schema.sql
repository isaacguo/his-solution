...
create table backup_entity (id bigint not null auto_increment, hour_value integer not null, schedule_type varchar(255), primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table database_operation_record_entity (id bigint not null auto_increment, finish_time datetime, folder_name varchar(255), log varchar(2048), operation varchar(255), result bit not null, start_time datetime, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
