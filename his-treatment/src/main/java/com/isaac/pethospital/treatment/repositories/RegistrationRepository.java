...
public interface RegistrationRepository extends JpaRepository<RegistrationEntity, Long> {
    ...
    @Query("select r.id as rid, r.indexOfDay as indexOfDay, p.id as pid, p.uuid as petUuid, p.name as petName, o.name as petOwnerName, r.registrationStatus as registrationStatus from RegistrationEntity r join r.pet p join p.petOwner as o where r.doctor=:doctor and r.bookDate>=:bookDate")
