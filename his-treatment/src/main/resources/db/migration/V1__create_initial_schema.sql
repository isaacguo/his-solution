...
create table pet_entity (id bigint not null auto_increment, age integer not null, color integer, date_of_birth datetime, gender integer, name varchar(255), sterilized bit not null, uuid varchar(255), pet_owner_id bigint, pet_type_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
