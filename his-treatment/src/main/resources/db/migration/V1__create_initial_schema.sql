...
create table treatment_case_entity (id bigint not null auto_increment, case_closed bit not null, clinic_situation varchar(255), created_date datetime, doctor_advice varchar(255), doctor_diagnose varchar(255), last_modified_date_time datetime, pet_owner_description varchar(255), treatment_date datetime, uuid varchar(255), doctor_id bigint, pet_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
