...
create table chargeable_category_entity (id bigint not null auto_increment, name varchar(255), parent_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table chargeable_item_entity (id bigint not null auto_increment, amount decimal(19,2), chargeable_item_id varchar(255), name varchar(255), name_han_yu_pin_yin varchar(255), specification varchar(255), unit varchar(255), uuid varchar(255), category_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
create table employee_entity (id bigint not null auto_increment, can_be_registered bit not null, emp_id bigint, login_account varchar(255), name varchar(255), self_introduction varchar(255), uuid varchar(255), department_id bigint, employee_type_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
create table pet_entity (id bigint not null auto_increment, age integer not null, color varchar(255), date_of_birth date, gender integer, name varchar(255), pet_type varchar(255), species varchar(255), sterilized bit not null, uuid varchar(255), pet_owner_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table pet_owner_entity (id bigint not null auto_increment, address varchar(255), cell_phone varchar(255), date_of_birth date, email varchar(255), gender integer, home_phone varchar(255), member_number varchar(255), name varchar(255), uuid varchar(255), primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
create table treatment_case_entity (id bigint not null auto_increment, case_closed bit not null, clinic_situation varchar(255), created_date datetime, doctor_advice varchar(255), doctor_diagnose varchar(255), last_modified_date_time datetime, pet_owner_description varchar(255), treatment_case_status varchar(255), treatment_date datetime, uuid varchar(255), doctor_id bigint, pet_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
