...
create table contact_entity (id bigint not null auto_increment, name varchar(255), telephone varchar(255), vendor_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table currency_entity (id bigint not null auto_increment, name varchar(255), primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table department_permission_entity (id bigint not null auto_increment, department_id bigint, department_name varchar(255), permitted bit not null, vendor_category_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table operator_entity (id bigint not null auto_increment, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table procurement_approval_entity (id bigint not null auto_increment, comments varchar(255), created_date_time datetime, review_result bit not null, reviewed bit not null, reviewed_date_time datetime, reviewer varchar(255), reviewer_full_name varchar(255), stage varchar(255), procurement_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table procurement_approval_stage_entity (id bigint not null auto_increment, stage varchar(255), previous_stage_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table procurement_configuration_entity (id bigint not null auto_increment, conf_key varchar(255), conf_value varchar(255), primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table procurement_entity (id bigint not null auto_increment, order_number varchar(255), status varchar(255), operator_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table procurement_log_entity (id bigint not null auto_increment, comment varchar(255), submitted_data datetime, procurement_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table procurement_purchase_entity (id bigint not null auto_increment, assign_to varchar(255), generated_date_time datetime, total_price double precision not null, procurement_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table procurement_purchase_entity_goods (procurement_purchase_entity_id bigint not null, goods_id bigint not null) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table procurement_purchase_good_entity (id bigint not null auto_increment, contact varchar(255), contact_telephone varchar(255), number double precision not null, package_specification varchar(255), package_unit varchar(255), price_per_unit double precision not null, total_price double precision not null, vendor varchar(255), procurement_purchase_id bigint, procurement_request_good_entity_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table procurement_request_good_entity (id bigint not null auto_increment, name varchar(255), number varchar(255), package_specification varchar(255), package_unit varchar(255), price_per_unit double precision not null, total_price double precision not null, request_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table procurement_requests (id bigint not null auto_increment, explanation varchar(255), requester varchar(255), requester_full_name varchar(255), submitted_data datetime, total_price double precision, procurement_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table procurement_request_vendor_info_entity (id bigint not null auto_increment, contact varchar(255), contact_telephone varchar(255), vendor varchar(255), vendor_id varchar(255), request_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table procurement_status_entity (id bigint not null auto_increment, last_status_result bit not null, status varchar(255), parent_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table procurement_type_entity (id bigint not null auto_increment, name varchar(255), primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
create table vendor_category_entity (id bigint not null auto_increment, name varchar(255), parent_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table vendor_entity (id bigint not null auto_increment, address varchar(255), description varchar(255), email varchar(255), name varchar(255), official_website_link varchar(255), postcode varchar(255), vendor_category_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table vendor_entity_contacts (vendor_entity_id bigint not null, contacts_id bigint not null) ENGINE=InnoDB DEFAULT CHARSET=utf8;
create table vendor_product_entity (id bigint not null auto_increment, currency varchar(255), order_number varchar(255), package_specification varchar(255), package_unit varchar(255), price_per_unit double precision, product_chinese_name varchar(255), product_english_name varchar(255), product_set bit not null, category_id bigint, parent_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
