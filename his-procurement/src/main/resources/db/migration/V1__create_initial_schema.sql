...
create table employee_entity (id bigint not null auto_increment, can_be_registered bit not null, emp_id bigint, login_account varchar(255), name varchar(255), self_whenFindByKeyThenReturnApprovalEntity introduction varchar(255), uuid varchar(255), department_id bigint, employee_type_id bigint, primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
